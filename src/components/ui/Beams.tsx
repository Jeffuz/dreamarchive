...
import { Moon, Scroll, Sparkles, BrainCircuit, Eye, Cloud, BookOpen } from "lucide-react";
...
export function Beams() {
    ...
    return (
        <div
            className="relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg p-3"
            ref={containerRef}
        >
